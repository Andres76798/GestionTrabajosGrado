...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            if (result > 0) {
                response.sendRedirect("mis_anteproyectos.jsp?mensaje=1");
                return;
            }
        } catch (Exception e) {
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">Subir Nuevo Anteproyecto</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="submit" class="btn btn-primary">Subir Anteproyecto</button>
                            </div>
                        </form>
                    </div>
                </div>
